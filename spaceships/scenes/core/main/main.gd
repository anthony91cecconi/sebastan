...
const VERSION_CHECK_URL_GITHUB = "https://raw.githubusercontent.com/anthony91cecconi/spaceships/refs/heads/main/version.json"
	...
	if not is_downloading:
		...
		if response_code == 200:
			...
			if OS.get_name() == "Android":
				...
				if exit_code != 0:
					info_label.text = "Aggiornamento pronto! Apri la cartella Download e clicca su spaceships_update.apk — oppure entra offline."
